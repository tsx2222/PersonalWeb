<template>
    <div id="main">
        <div id="diary">
            <el-button round style="margin-top: 1%" type="warning" @click="write">留言</el-button>
            ...
            <div class="message" v-for="item in message">
                <div style="width: 20%">
                    <img style="width: 94%;margin-left: 2%;margin-top: 15%" src="https://tsx-1302788370.file.myqcloud.com/sysImage/catlogo.gif" />
                </div>
